# GoBarber WEB ![logo](./src/assets/logo-purple.svg)
## Frontend web da aplicação GoBarber, desenvolvido em ReactJs durante o Bootcamp GoStack da Rocketseat.
### A aplicação está consumindo uma <a href="https://github.com/ManoelPradoMark22/API-GoBarber">API</a> produzida em NodeJs e tem como função exibir os agendamentos do salão de beleza em questão, agendamentos estes realizados pelos clientes da versão <a href="https://github.com/ManoelPradoMark22/app-GoBarber-Mobile">mobile</a> (produzida em React Native).
